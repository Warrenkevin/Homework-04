...
ggplot(mydata, aes(x = x, y = y)) + theme_minimal() +
          ...
          geom_line(aes(x = x, y = Upper_C, color = "Confidence")) + geom_line(aes(x = x, y = Fit_P, color = "Confidence"))  + geom_line(aes(x = x, y = Lower_P, color = "Confidence")) +
          geom_line(aes(x = x, y = Upper_P, color = "Confidence"))+ geom_smooth(method=lm) 
